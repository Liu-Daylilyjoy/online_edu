package com.hubu.online.utils;

import com.hubu.online.shiro.ShiroFunc;
...
public class TemplateConfiguration {
    ...
    public BeetlGroupUtilConfiguration getBeetlGroupUtilConfiguration() {
        ...
        if (loader == null) loader = TemplateConfiguration.class.getClassLoader();
        bguc.setResourceLoader(new ClasspathResourceLoader(loader, templatesPath));
        bguc.init();
        // 增加自定义函数
        bguc.getGroupTemplate().registerFunctionPackage("so", new ShiroFunc());
        // 增加自定义标签
